...
/* harmony default export */ const es_warning = (warning_warningOnce);
/* eslint-enable */
...
var Spin = /*#__PURE__*/function (_React$Component) {
  ...
  function Spin(props) {
    ...
    _this.renderSpin = function (_ref2) {
      ...
      var spinElement = /*#__PURE__*/react.createElement("div", extends_extends({}, divProps, {
        style: style,
      ...
      if (_this.isNestedPattern()) {
        ...
        return /*#__PURE__*/react.createElement("div", extends_extends({}, divProps, {
...
var SpinFC = function SpinFC(props) {
  ...
  var spinClassProps = extends_extends(extends_extends({}, props), {
    spinPrefixCls: spinPrefixCls
  });

  return /*#__PURE__*/react.createElement(Spin, extends_extends({}, spinClassProps));
};
...
var main = __webpack_require__(2191);
...
var getStartAtValue = function getStartAtValue(start, startAt) {
  ...
  return utils_getValue(value, startAt.vars, 1, startAt.count, startAt.unit);
};
var utils_getValue = function getValue(startVars, endVars, ratio) {
...
/* harmony default export */ const plugins = (new Plugin());
  ...
  this.getAnimStart = function () {
    ...
    for (var key in propsData.data) {
      ...
      if (cssName === 'transform') {
        transform = transform || (startData === varsValue ? _objectSpread2({}, varsValue) : (0,main/* getTransform */.Ck)(_this.computedStyle[_this.transformName]));
        ...
        filter = filter || (startData === varsValue ? _objectSpread2({}, varsValue) : (0,main/* splitFilterToObject */.GX)(styleValue) || {});
    ...
    for (var key in data) {
      ...
      if (isT) {
        if (key === 'scale') {
          ...
          transform[key] = utils_getValue(parseFloat(startValue), endValue, ratio, count, unit);
        }
        ...
        filter[fKey] = utils_getValue(startValue, endValue, ratio, count, unit);
        ...
        if (typeof endValue === 'string') {
          ...
          tweenVars[key] = utils_getValue(startValue, endValue, ratio, count, unit);
        }
      }
    }
...
/* harmony default export */ const StylePlugin = (style);
...
var ArrayPlugin = /*#__PURE__*/_createClass(function ArrayPlugin(_value, _key) {
  ...
  this.render = function (ratio) {
    ...
    var ratioData = data.map(function (c, i) {
      return typeof c === 'string' ? c : utils_getValue(start[i], c, ratio, count[i], unit[i]);
    });
  ...
  if (typeof _value === 'string') {
    if (_key.match(shadowExp)) {
      this.value = (0,main/* parseShadow */.hy)(_value, _key);
      _type = 'shadow';
    } else if (_key.match(/color|fill|stroke/i) || _value.match(colorRegExp)) {
      this.value = (0,main/* parseColor */.lu)(_value);
      _type = 'color';
    } else {
...
/* harmony default export */ const plugins_ArrayPlugin = (ArrayPlugin);
    ...
    (maxVarsLength === _this.vars.length ? _this.vars : _this.start).forEach(function (_, i) {
      ...
      var values = (maxLength === start.values.length ? start.values : item.values).map(function (_, i) {
        ...
        var color = cItem.color ? cItem.color.map(function (n, j) {
          return utils_getValue(startColor[j], n, ratio);
        }) : cItem.color;
        var positions = cItem.positions.map(function (n, j) {
          return "".concat(utils_getValue(startPos[j].data, n.data, ratio)).concat(n.unit);
        }).join(' ');
      ...
      var angleAngle = angle.angle && angle.angle.map(function (n, j) {
        return "".concat(utils_getValue(start.angle.angle[j].data, n.data, ratio)).concat(n.unit);
      }).join(' ');
      var anglePosition = angle.position && angle.position.map(function (n, j) {
        return "".concat(utils_getValue(start.angle.position[j].data, n.data, ratio)).concat(n.unit);
      }).join(' ');
...
/* harmony default export */ const animate_ticker = (ticker);
...
var tween_functions = __webpack_require__(1000);
...
(tween_functions_default()).path = function (_path, _param) {
  ...
  var pathNode = utils_parsePath(_path);
...
/* harmony default export */ const ease = ((tween_functions_default()));
    ...
    this.setRatioToVars = function (ratio) {
      ...
      for (var i = 0; i < root.targets.length; i++) {
        ...
        for (var key in vars) {
          ...
          root.vars[i][key] = utils_getValue(startVars, endVars, ratio, count, unit); //});
        } //});
...
var Tween = /*#__PURE__*/function () {
  function Tween(targets, _props) {
    ...
    this.init = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(vars) {
        var props;
...
/* harmony default export */ const es_TweenOne = (TweenOne);
...
/* harmony default export */ const es = (es_TweenOne);
...
/* harmony default export */ const animTypes = ({
  left: {
    opacity: [1, 0],
    translateX: [0, -30]
  },
...
var QueueAnim_excluded = ["component", "componentProps", "interval", "duration", "delay", "type", "animConfig", "ease", "leaveReverse", "forcedReplay", "animatingClassName", "onEnd", "appear"];
...
/* harmony default export */ const QueueAnim = (/*#__PURE__*/(0,react.forwardRef)(function (props, ref) {
  var _props$component = props.component,
      ...
      tagProps = _objectWithoutProperties(props, QueueAnim_excluded);
  /**
   * @param childrenShow;
  ...
  return (0,react.useMemo)(function () {
    ...
    if (utils_windowIsUndefined) {
      return /*#__PURE__*/(0,react.createElement)(component, _objectSpread2(_objectSpread2(_objectSpread2({}, tagProps), componentProps), {}, {
        ref: ref
      }));
    }
...
/* harmony default export */ const rc_queue_anim_es = (QueueAnim);
...
function Loading_createClass(Constructor, protoProps, staticProps) { if (protoProps) Loading_defineProperties(Constructor.prototype, protoProps); if (staticProps) Loading_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function Loading_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) Loading_setPrototypeOf(subClass, superClass); }

function Loading_setPrototypeOf(o, p) { Loading_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Loading_setPrototypeOf(o, p); }
...
function Loading_possibleConstructorReturn(self, call) { if (call && (Loading_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return Loading_assertThisInitialized(self); }
...
function Loading_getPrototypeOf(o) { Loading_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Loading_getPrototypeOf(o); }





var _Loading = /*#__PURE__*/function (_React$Component) {
  Loading_inherits(_Loading, _React$Component);

  var _super = Loading_createSuper(_Loading);

  function _Loading() {
    Loading_classCallCheck(this, _Loading);

    return _super.apply(this, arguments);
  }

  Loading_createClass(_Loading, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          children = _this$props.children,
          pastDelay = _this$props.pastDelay,
      ...
      if (children && !isLoading) {
        return /*#__PURE__*/react.createElement(rc_queue_anim_es, {
          style: {
            height: '100%',
            width: '100%'
          },
...
/* harmony default export */ const Loading = ((/* unused pure expression or super */ null && (_Loading)));
...
var useLayoutEffect_useLayoutEffect =  true && canUseDom() ? react.useLayoutEffect : react.useEffect;
/* harmony default export */ const hooks_useLayoutEffect = (useLayoutEffect_useLayoutEffect);
...
;// CONCATENATED MODULE: ./src/app/queue/a.js
/*
 * @Description: 
 * @Author: wanghexing
 * @Date: 2022-06-17 15:42:51
 * @LastEditors: wanghexing
 * @LastEditTime: 2022-06-17 15:42:56
 */

function a() {
  return /*#__PURE__*/react.createElement("div", null, "ss");
}
;// CONCATENATED MODULE: ./src/app/home/home.js

function Home() {
  return /*#__PURE__*/react.createElement("div", null, "hmhmh");
}
;// CONCATENATED MODULE: ./src/app/dynamic/index.js
/*
 * @Description: queue
 * @Author: wanghexing
 * @Date: 2022-06-16 17:56:47
 * @LastEditors: wanghexing
 * @LastEditTime: 2022-06-16 17:57:09
 */

function dynamic_index() {
  return /*#__PURE__*/react.createElement("div", null, "dynamic");
}
;// CONCATENATED MODULE: ./src/app/greedy/index.js
/*
 * @Description: queue
 * @Author: wanghexing
 * @Date: 2022-06-16 17:56:47
 * @LastEditors: wanghexing
 * @LastEditTime: 2022-06-16 17:57:01
 */

function greedy_index() {
  return /*#__PURE__*/react.createElement("div", null, "greedy");
}
...
var menuList = [{
  ...
  children: [{
    ...
    path: '/queue/a',
    key: '/queue/a',
    element: /*#__PURE__*/react.createElement(a, null),
    icon: ''
  }, {
    label: 'nav 3',
    path: '/queue/b',
  ...
  path: '/dynamic',
  key: '/dynamic',
  element: /*#__PURE__*/react.createElement(dynamic_index, null),
  icon: ''
}, {
  label: '贪心算法',
  path: '/greedy',
  key: '/greedy',
  element: /*#__PURE__*/react.createElement(greedy_index, null),
  icon: ''
}];
/* harmony default export */ const router = (menuList);
;// CONCATENATED MODULE: ./src/components/sideMenu.js




var sideMenu_Sider = es_layout.Sider;
function SideMenu(props) {
  var navigate = react_router_useNavigate();
  var location = react_router_useLocation();
  var selectKeys = [location.pathname];
  var openKeys = ["/" + location.pathname.split("/")[1]];
  console.log(openKeys);
  return /*#__PURE__*/react.createElement(sideMenu_Sider, {
    trigger: null,
    collapsible: true,
...
;// CONCATENATED MODULE: ./src/components/routList.js
/*
 * @Description: 
 * @Author: wanghexing
...
function RouterList() {
  var routerList = useRoutes(router);
  return routerList;
}
 ...
 * @Description: 
 * @Author: wanghexing
 * @Date: 2022-06-17 10:41:24
 * @LastEditors: wanghexing
 * @LastEditTime: 2022-06-17 17:06:43
 */
 //子模块--总路由
...
;// CONCATENATED MODULE: ./src/components/subApp.js
function subApp_slicedToArray(arr, i) { return subApp_arrayWithHoles(arr) || subApp_iterableToArrayLimit(arr, i) || subApp_unsupportedIterableToArray(arr, i) || subApp_nonIterableRest(); }

function subApp_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function subApp_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return subApp_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return subApp_arrayLikeToArray(o, minLen); }

function subApp_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function subApp_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function subApp_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var subApp_Header = es_layout.Header,
    subApp_Content = es_layout.Content;
function SubApp() {
  var _useState = (0,react.useState)(false),
      _useState2 = subApp_slicedToArray(_useState, 2),
      collapsed = _useState2[0],
      setCollapsed = _useState2[1];

  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(header_Header, null), /*#__PURE__*/react.createElement(es_layout, null, /*#__PURE__*/react.createElement(SideMenu, {
    collapsed: collapsed
  }), /*#__PURE__*/react.createElement(es_layout, {
    className: "site-layout"
  }, /*#__PURE__*/react.createElement(subApp_Header, {
  ...
  })), /*#__PURE__*/react.createElement(subApp_Content, {
    className: "site-layout-background",
    style: {
      margin: '24px 16px',
      padding: 24,
  ...
  }, /*#__PURE__*/react.createElement(RouterList, null)))), /*#__PURE__*/react.createElement(footer_Header, null));
}
...
function AppEntry() {
  return /*#__PURE__*/react.createElement(HashRouter, null, /*#__PURE__*/react.createElement(Routes, null, /*#__PURE__*/react.createElement(Route, {
    path: "/*",
    element: /*#__PURE__*/react.createElement(SubApp, null)
  })));
}
...
root.render( /*#__PURE__*/react.createElement(AppEntry, null));
})();
